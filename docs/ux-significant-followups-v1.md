...
- [ ] **UX-F0-01** Characterize the current export seam. Add focused tests that
...
- [ ] **UX-F0-02** Define a pure typed export orchestration contract. Depends on
...
- [ ] **UX-F0-03** Add an export frame capture adapter. Depends on UX-F0-02.
...
- [ ] **UX-F0-04** Compose complete grid output through the orchestrator.
...
- [ ] **UX-F0-05** Compose complete packed output through the orchestrator.
...
- [ ] **UX-F0-06** Package deterministic download results. Depends on UX-F0-04
...
- [ ] **UX-F0-07** Integrate bounded progress and cancellation. Depends on
...
- [ ] **UX-F1-01** Replace the placeholder export status with explicit run
...
- [ ] **UX-F1-02** Add safe browser download lifecycle handling. Depends on
...
- [ ] **UX-F1-03** Add focused export browser coverage. Depends on UX-F1-02.
...
- [ ] **UX-F1-04** Cover cancellation and failures in Chromium. Depends on
...
- [ ] **UX-F1-05** Reconcile release documentation. Depends on UX-F1-03 and
...
- [ ] **UX-V0-01** Add a pure viewport-preset model. Define the three presets,
...
- [ ] **UX-V0-02** Extend runtime-validated UI preferences. Depends on UX-V0-01.
...
- [ ] **UX-V0-03** Route presets through the viewport renderer. Depends on
...
- [ ] **UX-V0-04** Gate editing without losing context. Depends on UX-V0-03.
...
- [ ] **UX-V1-01** Add the compact labelled preset control. Depends on UX-V0-04.
...
- [ ] **UX-V1-02** Add screenshot-based preset coverage. Depends on UX-V1-01.
...
- [ ] **UX-V1-03** Cover persistence and interaction boundaries. Depends on
...
- [ ] **UX-V1-04** Document the viewport presets. Depends on UX-V1-02 and
...
- [ ] **UX-T0-01** Characterize the misleading empty-selection state. Add a
...
- [ ] **UX-T0-02** Add a pure effective-row-mode resolver. Depends on UX-T0-01.
...
- [ ] **UX-T0-03** Migrate the stored timeline preference. Depends on UX-T0-02.
...
- [ ] **UX-T0-04** Make counts and empty states describe visible content.
...
- [ ] **UX-T0-05** Preserve pin and synchronization behavior. Depends on
...
- [ ] **UX-T1-01** Define a compact two-row control layout. Keep clip tabs and
...
- [ ] **UX-T1-02** Remove permanently reserved inapplicable actions. Depends on
...
- [ ] **UX-T1-03** Preserve direct timeline manipulation. Depends on UX-T1-01.
...
- [ ] **UX-T1-04** Add a visible-row layout gate. Depends on UX-T1-01 and
...
- [ ] **UX-T1-05** Update timeline documentation. Depends on UX-T1-03 and
...
- [ ] **UX-D0-01** Characterize every current drop source and target. Cover OS
...
- [ ] **UX-D0-02** Extract and reuse a typed external-drop classifier. Depends on
...
- [ ] **UX-D0-03** Add a pure single-image import-and-place planner. Depends on
...
- [ ] **UX-D0-04** Add a bulk-import result model. Depends on UX-D0-02. For
...
- [ ] **UX-D1-01** Accept external drops on the canvas. Depends on UX-D0-03 and
...
- [ ] **UX-D1-02** Complete the single-image workflow. Depends on UX-D1-01.
...
- [ ] **UX-D1-03** Complete the bulk-import handoff. Depends on UX-D1-01. Import
...
- [ ] **UX-D1-04** Replace the empty-canvas guidance. Depends on UX-D1-02 and
...
- [ ] **UX-D1-05** Add failure, focus, and accessibility coverage. Depends on
...
- [ ] **UX-D1-06** Update import and first-run documentation. Depends on
...
- [ ] **UX-R0-01** Run the complete regression gate after all workstreams are
...
- [ ] **UX-R0-02** Perform the final visible workflow pass. Depends on UX-R0-01.
...
- [ ] **UX-R0-03** Audit serialization and history boundaries. Depends on
...
- [ ] **UX-R0-04** Reconcile task and release claims. Depends on UX-R0-02 and
...
- Documentation commit: _pending_
- `bun run check`: _pending_
- `bun run test:e2e`: _pending_
- Visible review artifacts: _pending_
